...
echo "$($PSQL "select t.name from teams t join games g on t.team_id = g.winner_id or t.team_id = g.opponent_id where g.year = 2014 and round = 'Eighth-Final' order by t.name ")"
